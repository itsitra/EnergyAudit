...
import { DataFlow, LevelDatas, Flow5path } from "../../../Model/DataflowModel";
import {
  NbComponentStatus,
...
@Component({
  selector: "ngx-flow5",
  templateUrl: "./flow5.component.html",
  styleUrls: ["./flow5.component.scss"],
})
export class Flow5Component implements OnInit {
  ...
  loadCurrentlevelDatas() {
    this.levelDetails = [];
    let LevelData = this.flowData.Flow5.Data[this.activeLevelIndex];
