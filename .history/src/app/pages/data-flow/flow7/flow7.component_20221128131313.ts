...
import { DataFlow, LevelDatas, Flow7path } from "../../../Model/DataflowModel";
import {
  NbComponentStatus,
...
@Component({
  selector: "ngx-flow7",
  templateUrl: "./flow7.component.html",
  styleUrls: ["./flow7.component.scss"],
})
export class Flow7Component implements OnInit {
  flowData = new DataFlow();
  levelDetails = [];
  activeParentKey = "";
  activeParentId = "";
  activeLevelIndex = 0;
  flowPaths = new Flow7path().Data;
  ...
  loadCurrentlevelDatas() {
    this.levelDetails = [];
    let LevelData = this.flowData.Flow7.Data[this.activeLevelIndex];
