...
@Component({
  ...
  styleUrls: ["./flow1.component.scss"],
})
export class Flow1Component implements OnInit {
  ...
  activeParentId = "";
  activeLevelIndex = 0;
  flowPaths = new Flow1path().Data;
  tableStructure = new Flow1tableData().Data;
  ...
  loadCurrentlevelDatas() {
    this.levelDetails = [];
    let LevelData = this.flowData.Flow1.Data[this.activeLevelIndex];
  ...
  fetchTableviewData() {
    let payloadObject = { custid: this.customerId, FlowNo: 1 };
    this.flowService
