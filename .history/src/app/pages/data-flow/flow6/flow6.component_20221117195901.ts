...
import { DataFlow, LevelDatas, Flow6path } from "../../../Model/DataflowModel";
import {
  NbComponentStatus,
...
@Component({
  selector: "ngx-flow6",
  templateUrl: "./flow6.component.html",
  styleUrls: ["./flow6.component.scss"],
})
export class Flow6Component implements OnInit {
  ...
  loadCurrentlevelDatas() {
    this.levelDetails = [];
    let LevelData = this.flowData.Flow6.Data[this.activeLevelIndex];
