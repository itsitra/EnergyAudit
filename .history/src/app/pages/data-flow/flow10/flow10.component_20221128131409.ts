...
import { DataFlow, LevelDatas, Flow10path } from "../../../Model/DataflowModel";
import {
  NbComponentStatus,
...
@Component({
  selector: "ngx-flow10",
  templateUrl: "./flow10.component.html",
  styleUrls: ["./flow10.component.scss"],
})
export class Flow10Component implements OnInit {
  flowData = new DataFlow();
  levelDetails = [];
  activeParentKey = "";
  activeParentId = "";
  activeLevelIndex = 0;
  flowPaths = new Flow10path().Data;
  ...
  loadCurrentlevelDatas() {
    this.levelDetails = [];
    let LevelData = this.flowData.Flow10.Data[this.activeLevelIndex];
