...
import { DataFlow, LevelDatas, Flow9path } from "../../../Model/DataflowModel";
import {
  NbComponentStatus,
...
@Component({
  selector: "ngx-flow9",
  templateUrl: "./flow9.component.html",
  styleUrls: ["./flow9.component.scss"],
})
export class Flow9Component implements OnInit {
  flowData = new DataFlow();
  levelDetails = [];
  activeParentKey = "";
  activeParentId = "";
  activeLevelIndex = 0;
  flowPaths = new Flow9path().Data;
  ...
  loadCurrentlevelDatas() {
    this.levelDetails = [];
    let LevelData = this.flowData.Flow9.Data[this.activeLevelIndex];
