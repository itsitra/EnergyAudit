...
export class ObservationComponent implements OnInit {
  ...
  Edit(ID: any) {
    let data = this.ObservationDataList[ID];
  ...
  InputFieldsList() {
    ...
    this.Observation.InputField(data).subscribe((data) => {
      // console.log("data>>>>>>>>", data);
  ...
  ObservationList() {
    ...
    this.Observation.ObservationDataList(data).subscribe((data) => {
      console.log("data for observation", data);
      this.ObservationDataList = data;
    });
  }
  ...
  onSubmit() {
    ...
    this.empList.forEach((data) => {
      if (data.value == "") {
        ...
        this.ObservationDataList[name] = data.value;
    ...
    if (this.empList.length == objectLength) {
      ...
      if (this.Btn_Name == "Save") {
        ...
        this.Observation.InsertDate(lengthcheck).subscribe((data) => {
          if (data == true) {
            this.showToast(
              "success",
        ...
        this.Observation.UpdateDate(lengthcheck).subscribe((data) => {
          if (data == true) {
            this.showToast(
              "success",
              "Observation Management",
  ...
  onDeleteConfirm(ID: string) {
    ...
    if (window.confirm("Are you sure you want to delete?")) {
      this.Observation.DeleteObservation(data).subscribe((data) => {
        if (data == true) {
