  ...
  openModalbox(title: string) {
    if (title === "Questionnaire Management") {
      ...
      if (
          ...
          if (typeof result != "undefined") {
            if (result.data.status === "closed") {
              this.router.navigateByUrl(
                `pages/Questionnaire-Management/${result.data.Audit}/${result.data.Mill}/${result.data.Questionnaire}/${result.data.Customer}`
              );
            }
          }
        });
        ...
        this.router.navigateByUrl(
          `pages/Questionnaire-Management/${Audit_id}/${Mill_id}/${Questionaire_Id}/${Costomer_Id}`
        );
      }
    }
      ...
      if (
        ...
        dialogRef.afterClosed().subscribe((result: any) => {
          if (typeof result != "undefined") {
            ...
            if (result.data.status === "closed") {
              this.router.navigateByUrl(
                `pages/Observation-Management/${result.data.Audit}/${result.data.Mill}/${result.data.Observable}/${result.data.Customer}`
              );
            }
          }
        });
        ...
        this.router.navigateByUrl(
          `pages/Observation-Management/${Audit_id}/${Mill_id}/${Observable_Id}/${Costomer_Id}`
        );
      }
    }
      ...
      if (
        ...
        dialogRef.afterClosed().subscribe((result: any) => {
          if (typeof result != "undefined") {
            ...
            if (result.data.status === "closed") {
              this.router.navigateByUrl(
                `/pages/Intermediate-Management/${result.data.Audit}/${result.data.Mill}/${result.data.Intermediate}/${result.data.Customer}`
              );
            }
          }
        });
        ...
        this.router.navigateByUrl(
          `pages/Intermediate-Management/${Audit_id}/${Mill_id}/${Intermediate_Id}/${Costomer_Id}`
        );
      }
    }
