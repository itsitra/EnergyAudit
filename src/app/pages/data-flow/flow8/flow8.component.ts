...
import { DataFlow, LevelDatas, Flow8path } from "../../../Model/DataflowModel";
import {
  NbComponentStatus,
...
@Component({
  selector: "ngx-flow8",
  templateUrl: "./flow8.component.html",
  styleUrls: ["./flow8.component.scss"],
})
export class Flow8Component implements OnInit {
  flowData = new DataFlow();
  levelDetails = [];
  activeParentKey = "";
  activeParentId = "";
  activeLevelIndex = 0;
  flowPaths = new Flow8path().Data;
  ...
  loadCurrentlevelDatas() {
    this.levelDetails = [];
    let LevelData = this.flowData.Flow8.Data[this.activeLevelIndex];
