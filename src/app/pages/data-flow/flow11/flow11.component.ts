...
import { DataFlow, LevelDatas, Flow11path } from "../../../Model/DataflowModel";
import {
  NbComponentStatus,
...
@Component({
  selector: "ngx-flow11",
  templateUrl: "./flow11.component.html",
  styleUrls: ["./flow11.component.scss"],
})
export class Flow11Component implements OnInit {
  flowData = new DataFlow();
  levelDetails = [];
  activeParentKey = "";
  activeParentId = "";
  activeLevelIndex = 0;
  flowPaths = new Flow11path().Data;
  ...
  loadCurrentlevelDatas() {
    this.levelDetails = [];
    let LevelData = this.flowData.Flow11.Data[this.activeLevelIndex];
