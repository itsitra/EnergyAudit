...
import { DataFlow, LevelDatas, Flow2path } from "../../../Model/DataflowModel";
import {
  NbComponentStatus,
...
@Component({
  ...
  styleUrls: ["./flow2.component.scss"],
})
export class Flow2Component implements OnInit {
  ...
  loadCurrentlevelDatas() {
    this.levelDetails = [];
    let LevelData = this.flowData.Flow2.Data[this.activeLevelIndex];
